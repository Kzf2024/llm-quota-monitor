...
struct TestRunner {
    static func main() async {
        ...
        run("testAPIKeyEntryBackwardCompat", testAPIKeyEntryBackwardCompat)
        run("testProviderDisplayNames", testProviderDisplayNames)
        run("testDeepSeekBalanceResponseParsing", testDeepSeekBalanceResponseParsing)
        run("testDeepSeekLowBalance", testDeepSeekLowBalance)
        run("testDeepSeekCurrencySymbol", testDeepSeekCurrencySymbol)
        ...
        run("testBuildDeepSeekInfo_Success", testBuildDeepSeekInfo_Success)
        run("testBuildDeepSeekInfo_NoBalanceInfos", testBuildDeepSeekInfo_NoBalanceInfos)
        run("testBuildDeepSeekInfo_EmptyBalanceInfos", testBuildDeepSeekInfo_EmptyBalanceInfos)
        run("testStatusBarTitle_Idle", testStatusBarTitle_Idle)
        run("testStatusBarTitle_Loading", testStatusBarTitle_Loading)
        run("testStatusBarTitle_LoadedZhiPu", testStatusBarTitle_LoadedZhiPu)
        run("testStatusBarTitle_LoadedDeepSeek", testStatusBarTitle_LoadedDeepSeek)
